...
import "./mocks/MockEgiftcardContract.sol";
...
contract TWFactoryTest is ITWFactoryData, BaseTest {
    ...
    // Test params
    MockEgiftcardContract internal mockModule;
    ...
    function setUp() public override {
        ...
        mockModule = new MockEgiftcardContract();
    }
    ...
    function test_addImplementation_directV2() public {
        MockEgiftcardContractV2 mockModuleV2 = new MockEgiftcardContractV2();
    ...
    function test_deployProxyByImplementation(bytes32 _salt) public {
        ...
        assertEq(mockModule.contractType(), MockEgiftcardContract(computedProxyAddr).contractType());
    }
    ...
    function test_deployProxy() public {
        ...
        assertEq(mockModule.contractType(), MockEgiftcardContract(proxyAddr).contractType());
    }
